...
def check_http_status(url: str) -> None:
    ...
    try:
        ...
        if request.status_code == 200:
            ...
            print ("Success. The web site exists, the server appears to be online and functioning correctly.")
        elif request.status_code == 400:
            print ("The request status code is", request.status_code)
            print ("The base web site exists, but the requested page",url,"is not working.")
        elif request.status_code == 404:
            print ("The request status code is", request.status_code)
            print ("The base web site exists, but the requested page",url,"is not available.")
        elif request.status_code == 500:
            print ("The request status code is", request.status_code)
            print ("Internal server error. The base web site exists, but the requested page",url,"is not available.")
        elif request.status_code == 502:
            print ("The request status code is", request.status_code)
            print ("Bad gateway. The base web site exists, but the requested page",url,"is not available.")
        else:
            print ("The request status code is", request.status_code)
